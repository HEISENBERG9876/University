...
(define (morse-code input_str)
  ...
  (define (normalize char_list prev_spaces) ;zamienia liste znakow na liste znakow z odpowiednia iloscia spacji w kodzie Morse'a
    (match char_list
      ['() '()]
      ...
      [(cons first rest) (cons first (cons #\space (normalize rest 0)))]))
